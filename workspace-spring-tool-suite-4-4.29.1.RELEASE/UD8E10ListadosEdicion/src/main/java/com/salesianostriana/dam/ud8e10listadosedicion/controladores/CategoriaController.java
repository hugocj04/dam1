...
public class CategoriaController {
	...
	/**
	 * Método que nos atiende la petición (no hace falta escribir nada en el navegador) 
	 * de la página inicial
	 * Para pintar esa página "dinámicamente" necesitamos las 
	 * categorías para ponerlas en el menú lateral, por lo que añadimos al modelo
	 ...
	 * debemos usar en la plantilla html para acceder a ella)
	 ...
	 * por tener anotada la clase con RequestMapping
	 * Esto sucederá cuando dentro del menú Gestión de categorías 
	...
	public String submitNuevaCategoria(@ModelAttribute("categoria") Categoria categoria, Model model) {
		...
		//no podemos ahorrar la parte inicial como hacemos en 
		//los GetMapping o PostMapping
	 ...
	 * y es del tipo Long
	 * 
	 * Ojo, la búsqueda con findById debería devolver un Optional, como hemos 
	 * visto en otros casos (Ejemplo CRUD completo con base de datos sin asociaciones) 
	...
	public String editarCategoria(@PathVariable("id") Long id, Model model) {
		...
		/* Si te fijas en el método nuevaCategoría, al model le pasamos 
		 * una new categoria ( ) vacía porque es el de agregar nueva categoría.
		 * Ahora pasamos la categoría que nos devuelve el método findById (id) 
		 * que está justo encima de este comentario, por lo que, el 
