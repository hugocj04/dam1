...
public class Principal {
	...
	public static void main(String[] args) {
		...
		String[] alumnos;
		int[] notas;
		int tam, mayor = 0, menor = 0, contadorAprobados = 0, contadorSuspensos = 0, respuesta, indiceMayor = 0, indiceMenor = 0, totalNotas = 0, media = 0;
		...
		do {
			...
			System.out.println("\nEl nota mas alta la tiene " + alumnos[indiceMayor] + " con un " + mayor + " y la nota mas baja la tiene " + alumnos[indiceMenor] + " con un " + menor);
